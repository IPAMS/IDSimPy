...
class TestVisualization_images(unittest.TestCase):
	...
	def setUpClass(cls):
		...
		cls.test_reactive_projectName = os.path.join(data_file_base_path, 'qitSim_2019_04_scanningTrapTest',
		                                             'qitSim_2019_04_15_001')
		cls.test_hdf5_trajectory_a = os.path.join(data_file_base_path, 'qitSim_2019_04_scanningTrapTest',
		                                          'qitSim_2019_04_10_001_trajectories.hd5')
		cls.test_hdf5_trajectory_b = os.path.join(data_file_base_path, 'qitSim_2019_04_scanningTrapTest',
		                                          'qitSim_2019_04_10_002_trajectories.hd5')
		cls.test_hdf5_trajectory_c = os.path.join(data_file_base_path, 'qitSim_2019_04_scanningTrapTest',
