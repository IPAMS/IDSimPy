...
class TestChemistry(unittest.TestCase):
	...
	def setUpClass(cls):
		...
		cls.test_concentrations_a = os.path.join(data_file_base_path, 'qitSim_2019_04_scanningTrapTest',
		                                          'qitSim_2019_04_10_001_concentrations.txt')
		cls.test_concentrations_b = os.path.join(data_file_base_path, 'qitSim_2019_04_scanningTrapTest',
